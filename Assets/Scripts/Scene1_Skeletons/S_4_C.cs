...
public class S_4_C : MonoBehaviour
{
	public static S_4_C instance;
	public float speed;
    ...
    void Update()
    {
		if(S_4_HC.instance.currentHealth <= 0) {
	...
	private void AttackPlayer() {
		if (CharacterHealthController.instance.currentHealth <= 0 || S_4_HC.instance.currentHealth <= 0) {
			CancelInvoke("AttackPlayer");
		}
		else {
