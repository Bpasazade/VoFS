...
public class S_3_HC : MonoBehaviour
{
    public int maxHealth;
    public int currentHealth;
    public static S_3_HC instance;
    ...
    public void TakeDamage() {
        ...
        if (takeDamageCounter <= 0) {
            ...
            if (currentHealth <= 0) {
                ...
                S_3_C.instance.animator.SetBool("player_in", false);
                S_3_C.instance.animator.SetBool("isDead", true);
