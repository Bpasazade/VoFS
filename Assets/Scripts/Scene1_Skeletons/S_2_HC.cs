...
public class S_2_HC : MonoBehaviour
{
    public int maxHealth;
    public int currentHealth;
    public static S_2_HC instance;
    ...
    public void TakeDamage() {
        ...
        if (takeDamageCounter <= 0) {
            ...
            if (currentHealth <= 0) {
                ...
                S_2_C.instance.animator.SetBool("player_in", false);
                S_2_C.instance.animator.SetBool("isDead", true);
