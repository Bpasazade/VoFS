...
public class S_3_C : MonoBehaviour
{
	public static S_3_C instance;
	public float speed;
    ...
    void Update()
    {
		if(S_3_HC.instance.currentHealth <= 0) {
	...
	private void AttackPlayer() {
		if (CharacterHealthController.instance.currentHealth <= 0 || S_3_HC.instance.currentHealth <= 0) {
			CancelInvoke("AttackPlayer");
		}
		else {
