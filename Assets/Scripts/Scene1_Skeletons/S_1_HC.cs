...
public class S_1_HC : MonoBehaviour
{
    public int maxHealth;
    public int currentHealth;
    public static S_1_HC instance;
    ...
    public void TakeDamage() {
        ...
        if (takeDamageCounter <= 0) {
            ...
            if (currentHealth <= 0) {
                ...
                S_1_C.instance.animator.SetBool("player_in", false);
                S_1_C.instance.animator.SetBool("isDead", true);
